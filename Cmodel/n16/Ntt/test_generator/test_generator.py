...
# -------------------------------------------------------------------------- TXT
PRM_TXT       = open("D:/FHE/IDEA/NTT_iter/Cmodel/n16/Ntt/test_generator/test/PARAM.txt","w")
NTT_DIN_TXT   = open("D:/FHE/IDEA/NTT_iter/Cmodel/n16/Ntt/test_generator/test/NTT_DIN.txt","w")
NTT_DOUT_TXT  = open("D:/FHE/IDEA/NTT_iter/Cmodel/n16/Ntt/test_generator/test/NTT_DOUT.txt","w")
INTT_DIN_TXT  = open("D:/FHE/IDEA/NTT_iter/Cmodel/n16/Ntt/test_generator/test/INTT_DIN.txt","w")
INTT_DOUT_TXT = open("D:/FHE/IDEA/NTT_iter/Cmodel/n16/Ntt/test_generator/test/INTT_DOUT.txt","w")
W_TXT         = open("D:/FHE/IDEA/NTT_iter/Cmodel/n16/Ntt/test_generator/test/W.txt","w")
WINV_TXT      = open("D:/FHE/IDEA/NTT_iter/Cmodel/n16/Ntt/test_generator/test/WINV.txt","w")
# -------------------------------------------------------------------------- TXT
