...
void NTT_16(uint32_t *A, uint32_t N, uint32_t phi, uint32_t q) {
    uint32_t i;
    uint32_t j;
    uint32_t k;
...
void Inv_NTT_16(uint32_t *C, uint32_t N, uint32_t phi_inv, uint32_t inv_2, uint32_t q) {
    uint32_t i;
    uint32_t j;
    uint32_t k;
